...
if len(sys.argv) < 2:
	sys.exit("Please run script following with stock ticker to get 1 min candle chart, for example $ ./realtime_candle.py AAPL")
...
#上市股: '股票代碼.tw'
#上櫃股: '股票代碼.two'
stock = y.download(ticker, period='1d', interval='1m')
